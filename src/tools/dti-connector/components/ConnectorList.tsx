    ...
    <div className="max-w-5xl animate-fade-in">
      ...
      {connectors.length === 0 ? (
        <div className="bg-bg-surface border border-border rounded p-10 text-center">
          ...
          <p className="text-sm text-txt-secondary">Noch keine Connectors vorhanden.</p>
          <p className="text-xs text-txt-muted mt-1">Erstelle deinen ersten Connector oben.</p>
        </div>
      ) : (
